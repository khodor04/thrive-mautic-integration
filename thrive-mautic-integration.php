...
add_action('wp_ajax_test_mautic_connection', function() {
    try {
        ...
        error_log('Thrive Mautic Connection Test Error: ' . $e->getMessage());
...
add_action('admin_init', function() {
    try {
        ...
        error_log('Thrive Mautic Update Check Error: ' . $e->getMessage());
    }
});
...
add_action('admin_notices', function() {
    try {
        ...
        error_log('Thrive Mautic Admin Notice Error: ' . $e->getMessage());
    }
});
...
register_activation_hook(__FILE__, function() {
    try {
        ...
        error_log('Thrive Mautic Activation Error: ' . $e->getMessage());
    }
});
...
register_deactivation_hook(__FILE__, function() {
    try {
        ...
        error_log('Thrive Mautic Deactivation Error: ' . $e->getMessage());
    }
});