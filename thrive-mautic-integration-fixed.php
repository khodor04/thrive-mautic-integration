 ...
 * Description: Complete Thrive Themes integration with Mautic
 * Version: 4.1.0
 * Author: Your Name
...
add_action('admin_menu', function() {
    add_menu_page(
        ...
        function() {
            ...
            echo '<p>Plugin is working! This is the fixed version.</p>';
            echo '<p>Version: ' . THRIVE_MAUTIC_VERSION . '</p>';
...
register_activation_hook(__FILE__, function() {
    if (class_exists('ThriveMautic\\Database')) {
        $database = new ThriveMautic\Database();
        $database->create_tables();
    }
    error_log('Thrive Mautic plugin activated successfully');
});
